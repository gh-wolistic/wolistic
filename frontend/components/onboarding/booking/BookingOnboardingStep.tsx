...
type BookingOnboardingStepProps = {
...
export function BookingOnboardingStep({
  questionForm,
  mandatoryQuestions,
  questionAnswers,
  questionError,
...
}: BookingOnboardingStepProps) {
  return (
    <form
      className="mt-5 space-y-4 rounded-xl border border-emerald-300 bg-background p-5 shadow-md dark:border-emerald-500/30"
      onSubmit={onSubmit}
    >
